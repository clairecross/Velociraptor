...
#export  
write.csv(patient.abundance, paste0(output.path, '/unfiltered/',
                                  strftime(Sys.time(),"%Y-%m-%d"),
                                  " original_cluster_patient_abundances.csv"))


#cox proportional hazards model
cluster.survival.analysis <- cox_ph_cluster_fxn(patient.abundance)
survival.plots <- cluster.survival.analysis[[1]]
pval.list <- cluster.survival.analysis[[2]]
HR.list <- cluster.survival.analysis[[3]]
#export
...
write.csv(cluster.stats,paste0(output.path, '/unfiltered/', strftime(Sys.time(),"%Y-%m-%d"), 
                               " original_DBSCAN_cluster_counts_and_stats.csv"))
```
